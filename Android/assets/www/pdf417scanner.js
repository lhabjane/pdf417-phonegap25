...
cordova.define("cordova/plugins/pdf417Scanner", 
  function(require, exports, module) {
    var exec = require("cordova/exec");
    var Pdf417Scanner = function() {};
...
if (!window.plugins.pdf417Scanner) {
    window.plugins.pdf417Scanner = cordova.require("cordova/plugins/pdf417Scanner");
}